...
class __$$_ResendEmailCopyWithImpl<$Res>
    extends _$EmailVerificationFormEventCopyWithImpl<$Res, _$_ResendEmail>
...
class _$_ResendEmail implements _ResendEmail {
  ...
  @override
  String toString() {
    return 'EmailVerificationFormEvent.resendEmail(email: $email)';
  }
...
abstract class _ResendEmail implements EmailVerificationFormEvent {
...
class _$_EmailVerificationFormState implements _EmailVerificationFormState {
  ...
  @override
  String toString() {
    return 'EmailVerificationFormState(state: $state, message: $message, isSubmitting: $isSubmitting, isTimeoutDone: $isTimeoutDone)';
  }
